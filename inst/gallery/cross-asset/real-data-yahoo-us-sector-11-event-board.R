...
.print_help <- function() {
  cat(
    paste(
      "Usage:",
      "Rscript inst/gallery/cross-asset/real-data-yahoo-us-sector-11-event-board.R --event_dates=2026-02-28,2026-04-07 --event_labels=\"Iran War,Ceasefire\" --from_date=2026-01-01",
      "",
      "Named arguments:",
