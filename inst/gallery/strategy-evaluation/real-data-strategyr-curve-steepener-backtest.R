...
market_dt <- investlabr::prep_ratio_ohlc(short_dt, long_dt, ratio_symbol = paste0(short_ticker, "/", long_ticker))
...
bt_res_2 <- investlabr::prep_backtest_result_from_equity(
