...
| Strategy explanation views | Not yet implemented | `strategyr` plus `investlabr::viz_*` | Need plots that explain signals, feature states, position changes, and PnL attribution, not only performance |
