...
| Publishing metadata | `build-alphasync-plot-registry.R`, `output/alphasync-plot-registry.json`, `output/meta/*.yaml` | `investlabr` | Registry-emission helpers and controlled metadata schema for AlphaSync/Hugo publishing |
