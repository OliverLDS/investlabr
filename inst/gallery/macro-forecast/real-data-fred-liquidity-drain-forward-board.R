...
wide <- investlabr::prep_series_wide(list(mf_load_fred("WRBWFRBL", "Reserves", start_date), mf_load_fred("WDTGAL", "TGA", start_date), mf_load_fred("WLRRAL", "Reverse repos", start_date)))
...
scenario <- investlabr::sim_scenario_path(latest_res, c("TGA rebuild drain" = -0.08, "RRP runoff cushion" = 0.03, "Neutral drift" = -0.02), horizon_months = 6)
