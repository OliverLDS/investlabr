...
liq <- investlabr::prep_series_wide(list(mf_load_fred("SOFR", "SOFR", start_date), mf_load_fred("IORB", "IORB", start_date), mf_load_fred("WRBWFRBL", "Reserves", start_date)))
liq[, stress := investlabr::prep_zscore(100 * (SOFR - IORB)) + investlabr::prep_zscore(-(Reserves - shift(Reserves, 20L)))]
