...
wide <- investlabr::prep_series_wide(list(mf_load_fred("CPIAUCSL", "CPI", start_date), mf_load_fred("UNRATE", "Unemployment", start_date), mf_load_fred("WRBWFRBL", "Reserves", start_date)))
