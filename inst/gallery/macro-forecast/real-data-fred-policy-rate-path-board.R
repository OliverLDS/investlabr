...
policy <- investlabr::prep_series_wide(list(
...
scenario_dt <- investlabr::sim_scenario_path(latest_iorb, c("Sticky restrictive" = 0.00, "Gradual normalization" = -0.25, "Renewed tightening" = 0.125), horizon_months = 6)
