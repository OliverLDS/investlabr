...
rates <- investlabr::prep_series_wide(list(
...
fan_2y <- investlabr::sim_forward_fan(tail(rates$DGS2[is.finite(rates$DGS2)], 1), investlabr::prep_recent_changes(rates$DGS2, recent_window), horizons, seed = 11)
fan_10y <- investlabr::sim_forward_fan(tail(rates$DGS10[is.finite(rates$DGS10)], 1), investlabr::prep_recent_changes(rates$DGS10, recent_window), horizons, seed = 12)
fan_slope <- investlabr::sim_forward_fan(tail(rates$`10Y-2Y`[is.finite(rates$`10Y-2Y`)], 1), investlabr::prep_recent_changes(rates$`10Y-2Y`, recent_window), horizons, seed = 13)
