...
wide <- investlabr::prep_series_wide(list(mf_load_fred("CPIAUCSL", "CPI", start_date), mf_load_fred("UNRATE", "Unemployment", start_date), mf_load_fred("T10Y2Y", "Curve slope", start_date), mf_load_fred("BAMLH0A0HYM2", "HY spread", start_date)))
