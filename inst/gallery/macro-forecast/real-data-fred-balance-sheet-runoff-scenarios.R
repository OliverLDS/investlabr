...
wide <- investlabr::prep_series_wide(list(mf_load_fred("WALCL", "Total assets", start_date), mf_load_fred("WSHOTSL", "Treasuries", start_date), mf_load_fred("WMBSEC", "MBS", start_date), mf_load_fred("WRBWFRBL", "Reserves", start_date)))
...
scenario <- investlabr::sim_scenario_path(latest_total, c("Current runoff" = -0.06, "Slower runoff" = -0.025, "Stabilization" = 0), horizon_months = 12)
